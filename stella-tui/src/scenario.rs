...
use serde_json::json;
use stella_protocol::{
    AgentEvent, ContextFrameRef, FileChangeKind, JudgeEvidence, PrStatus, ProviderShare,
    ScopeProposal, StageKind, ToolCall, ToolOutput,
};
...
pub fn demo_inbound(started_ms: u64, self_pid: u32) -> Vec<Inbound> {
    ...
    vec![
        ...
        ev(lead, AgentEvent::StepUsage { step: 1, model: "glm-5.2".into(), input_tokens: 12_400, output_tokens: 640, cached_input_tokens: 9_000, cache_write_tokens: 0, estimated_input_tokens: 12_000, cost_usd: 0.021, duration_ms: 1830, retries: 0, tool_calls: 0 }),
        ...
        ev(auth, AgentEvent::StepUsage { step: 1, model: "glm-5.2".into(), input_tokens: 5_100, output_tokens: 420, cached_input_tokens: 3_000, cache_write_tokens: 0, estimated_input_tokens: 5_000, cost_usd: 0.011, duration_ms: 1400, retries: 0, tool_calls: 1 }),
