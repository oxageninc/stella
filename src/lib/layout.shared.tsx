 ...
 *
 * Generic shadcn-neutral branding for now: a monospace "stella" wordmark next
 * to a terminal glyph, with a muted "docs" qualifier.
 */
  ...
  return {
    ...
    links: [
      ...
      },
      {
        type: "icon",
        text: "GitHub",
        url: "https://github.com/oxageninc/stella",
        icon: (
