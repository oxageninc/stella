...
| `.stella/reflections.jsonl` | Post-turn reflection log (lessons the [context engine](/docs/context-engine) distills) |
...
(prefer [`api_key_env` or `credentials.toml`](/docs/configuration/credentials)). The
