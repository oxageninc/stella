...
- **Built-in tools** — the always-available and conditionally-registered tools. See the full [Built-in Tools](/docs/tools) catalog for names and read-only/mutating flags.
